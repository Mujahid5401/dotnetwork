...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210619_dotnet_838aa81d7b35f5608679_20210619154423_archive.zip';
	const ARCHIVE_SIZE		 = '96570875';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '838aa81-19154423';
    const SECONDARY_PACKAGE_HASH = 'a54baff-19154423';
	const VERSION			 = '1.4.1';
